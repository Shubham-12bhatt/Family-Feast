  ...
  return (
    <section id="contact" className="py-20 bg-secondary-light/30">
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12">
        <div>
           <h2 className="text-4xl font-serif text-primary mb-6">Feel Free To Contact Us</h2>
           ...
           <form className="space-y-4">
             ...
             <button type="submit" className="bg-primary text-white px-10 py-3 rounded-full font-medium hover:bg-opacity-90 transition-shadow shadow-lg shadow-primary/30 cursor-pointer">
               Send
             </button>
           </form>
        </div>
